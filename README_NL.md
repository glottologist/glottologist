Hoi Allen.  Ik ben een polygot functioneel programmeur, natuurkundige, datawetenschapper, taalkundige, soms imker en vooral vader. @scala @haskell @idris @f# @rust @f*.
